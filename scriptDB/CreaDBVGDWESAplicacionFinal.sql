CREATE DATABASE IF NOT EXISTS DBVGDWESAplicacionFinal ;
...
CREATE USER IF NOT EXISTS "userVGDWESAplicacionFinal"@"%" IDENTIFIED by "paso";
GRANT ALL PRIVILEGES on *.* TO "userVGDWESAplicacionFinal"@"%" WITH GRANT OPTION;
FLUSH PRIVILEGES;